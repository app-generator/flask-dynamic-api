...
### Dynamic API Checklist

> Feature mirrored from Django project: https://github.com/app-generator/priv-dynamic-services-django

| Status | Item | info | 
| --- | --- | --- |
| ✅ | New Models Definition in `apps/models` | - |
| ✅ | Dynamic API via Flask-RestX | - |
...
| ✅ | Solution to restrict the API for registered users | Enable/disable via config | 

<br />
<br />

---
Using the api is the same as the django version.
But there is a difference to restrict unlogged users.
